...
equation
  ...
  connect(chassisBus, controlBus.chassisBus) annotation (Line(
        ...
        color={255,204,51},
        thickness=0.5));
  connect(sensor_r_0.r[1], chassisBus.position_x) annotation (Line(points={{-29,
          59.6667},{-22,59.6667},{-22,58},{60,58},{60,0}},                                                                       color={0,0,127}));
  connect(sensor_r_0.r[2], chassisBus.position_y) annotation (Line(points={{-29,60},{62,60},{62,2},{60,2},{60,0}}, color={0,0,127}));
  connect(sensor_r_0.r[3], chassisBus.position_phi) annotation (Line(points={{-29,
          60.3333},{-22,60.3333},{-22,62},{64,62},{64,2},{60,2},{60,0}},                                                                         color={0,0,127}));
  connect(sensor_v_0.v[1], chassisBus.velocity_dx) annotation (Line(points={{-29,
          29.6667},{52,29.6667},{52,2},{60,2},{60,0}},                                                                        color={0,0,127}));
  ...
  connect(sensor_v_0.v[3], chassisBus.velocity_dphi) annotation (Line(points={{-29,
          30.3333},{-22,30.3333},{-22,34},{56,34},{56,2},{60,2},{60,0}},                                                                          color={0,0,127}));
  ...
  connect(sensor_r_0.r[3], chassisBus.yawAngle) annotation (Line(points={{-29,
          60.3333},{-24,60.3333},{-24,64},{66,64},{66,2},{60,2},{60,0}},                                                                     color={0,0,127}), Text(
      string="%second",
      index=3,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(sensor_v_0.v[3], chassisBus.yawRate) annotation (Line(points={{-29,
          30.3333},{-24,30.3333},{-24,36},{58,36},{58,0},{60,0}},                                                                    color={0,0,127}), Text(
      string="%second",
      index=3,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));
  connect(sensor_v_chassis.v[1], chassisBus.longitudinalVelocity) annotation (Line(points={{-29,
          -30.3333},{0,-30.3333},{0,-14},{56,-14},{56,0},{60,0}},
        color={0,0,127}),
      Text(
        string="%second",
        index=1,
        extent={{6,3},{6,3}},
        horizontalAlignment=TextAlignment.Left));
  connect(sensor_v_chassis.v[1], calc_beta.u2) annotation (Line(points={{-29,
          -30.3333},{-24,-30.3333},{-24,-34},{8,-34}},                                                                    color={0,0,127}));
  connect(sensor_v_chassis.v[2], calc_beta.u1) annotation (Line(points={{-29,-30},{-26,-30},{-26,-46},{8,-46}}, color={0,0,127}));
  connect(sensor_a_chassis.a[1], chassisBus.longitudinalAcceleration) annotation (Line(points={{-29,
          -60.3333},{60,-60.3333},{60,0}},                                                                                           color={0,0,127}), Text(
      string="%second",
      index=1,
      extent={{6,3},{6,3}},
      horizontalAlignment=TextAlignment.Left));

...
protected
  ...
  Modelica.Blocks.Interfaces.RealOutput vveh_long "Absolut longitudinal vehicle speed" annotation (Placement(transformation(extent={{-10,-10},{10,10}}, rotation=180, origin={40,-40})));
...
equation
  ...
  // yaw rate damping
  delta_yaw = k_d_yaw*(yawRate_path - yawRate) + theta_ss_f;
